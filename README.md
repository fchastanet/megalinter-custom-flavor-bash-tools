...
It is built from official MegaLinter images, but is maintained on git@github.com:fchastanet/megalinter-custom-flavor-bash-tools by Francois Chastanet
...
- GitHub Action: On MegaLinter step in .github/workflows/mega-linter.yml, define `uses: git@github.com:fchastanet/megalinter-custom-flavor-bash-tools@main`
- Docker image: Replace official MegaLinter image with `ghcr.io/git@github.com:fchastanet/megalinter-custom-flavor-bash-tools/megalinter-custom-flavor:latest`
